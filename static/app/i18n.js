...
const translations = {
    ...
    'es-ES': {
        // Header
        'header.title': 'Consola de Administración AIClient2API',
        'header.description': 'Consola de Administración AIClient2API - Gestión unificada de proveedores de servicios de IA',
        'header.github': 'Repositorio GitHub',
        ...
        'header.reload.confirm': '¿Está seguro de que desea recargar la configuración? Esto recargará todos los archivos de configuración.',
        'header.reload.requesting': 'Recargando configuración...',
        'header.reload.success': 'Configuración recargada exitosamente',
        'header.reload.failed': 'Error al recargar la configuración',
        'header.refresh': 'Recargar',
        'header.restart': 'Reiniciar',
        'header.restart.confirm': '¿Está seguro de que desea reiniciar el servicio? El servicio estará brevemente interrumpido.',
        'header.restart.requesting': 'Solicitando reinicio del servicio...',
        'header.restart.success': 'Solicitud de reinicio enviada, el servicio se reiniciará pronto',
        'header.restart.reconnecting': 'Reconectando...',
        'header.restart.failed': 'Error al reiniciar el servicio',
        
        // Navigation
        'nav.main': 'Navegación Principal',
        'nav.dashboard': 'Panel de Control',
        'nav.guide': 'Guía de Usuario',
        'nav.tutorial': 'Tutorial de Configuración',
        'nav.config': 'Configuración',
        'nav.providers': 'Grupos de Proveedores',
        'nav.upload': 'Archivos de Credenciales',
        'nav.usage': 'Consulta de Uso',
        'nav.logs': 'Logs en Tiempo Real',
        'nav.plugins': 'Gestión de Plugins',
        'nav.models': 'Modelos Disponibles',
        
        // Dashboard
        'dashboard.title': 'Vista General del Sistema',
        'dashboard.uptime': 'Tiempo de Actividad',
        'dashboard.systemInfo': 'Información del Sistema',
        'dashboard.version': 'Versión',
        'dashboard.update.check': 'Buscar Actualización',
        'dashboard.update.checkTitle': 'Verificar si hay una nueva versión disponible',
        'dashboard.update.perform': 'Actualizar Ahora',
        'dashboard.update.performTitle': 'Actualizar a la última versión',
        'dashboard.update.checking': 'Verificando...',
        'dashboard.update.upToDate': 'Ya está actualizado',
        'dashboard.update.latest': 'Último',
        'dashboard.update.current': 'Actual',
        'dashboard.update.hasUpdate': 'Nueva versión disponible: {version}',
        'dashboard.update.updating': 'Actualizando...',
        'dashboard.update.success': 'Actualización exitosa',
        'dashboard.update.needsRestart': 'El código ha sido actualizado, haga clic en el botón "Reiniciar" en la esquina superior derecha para aplicar los cambios',
        'dashboard.update.restartTitle': 'Actualización Completada',
        'dashboard.update.restartMsg': 'El código se ha actualizado a la versión {version}, haga clic en el botón "Reiniciar" en la esquina superior derecha para aplicar el nuevo código.',
        'dashboard.update.failed': 'Error al actualizar: {error}',
        'dashboard.update.confirmTitle': 'Confirmar Actualización',
        'dashboard.update.confirmMsg': '¿Está seguro de que desea actualizar a la versión {version}? El servicio puede estar temporalmente indisponible durante la actualización.',
        'dashboard.nodeVersion': 'Versión de Node.js',
        'dashboard.serverTime': 'Hora del Servidor',
        'dashboard.memoryUsage': 'Uso de Memoria',
        'dashboard.cpuUsage': 'Uso de CPU',
        'dashboard.serviceMode': 'Modo de Servicio',
        'dashboard.serviceMode.worker': 'Modo Proceso Hijo',
        'dashboard.serviceMode.standalone': 'Modo Independiente',
        'dashboard.serviceMode.canRestart': 'Soporta reinicio automático',
        'dashboard.processPid': 'PID del Proceso',
        'dashboard.platform': 'Sistema Operativo',
        'dashboard.routing.title': 'Ejemplos de Enrutamiento de Rutas',
        'dashboard.routing.description': 'Acceda a diferentes proveedores de modelos de IA a través de diferentes rutas de URL, soportando cambio flexible de modelos',
        'dashboard.routing.oauth': 'Romper Límites',
        'dashboard.routing.official': 'API Oficial/Terceros',
        'dashboard.routing.experimental': 'Romper Límites/Experimental',
        'dashboard.routing.free': 'Romper Límites/Gratis',
        'dashboard.routing.endpoint': 'Ruta del Endpoint:',
        'dashboard.routing.example': 'Ejemplo de Uso',
        'dashboard.routing.exampleOpenAI': 'Ejemplo de Uso (Formato OpenAI):',
        'dashboard.routing.exampleClaude': 'Ejemplo de Uso (Formato Claude):',
        'dashboard.routing.openai': 'Protocolo OpenAI',
        'dashboard.routing.claude': 'Protocolo Claude',
        'dashboard.routing.tips': 'Consejos de Uso',
        'dashboard.routing.tip1': 'Cambio instantáneo: Cambie el proveedor de modelos de IA simplemente modificando la ruta URL',
        'dashboard.routing.tip2': 'Configuración del cliente: Configure el endpoint de API en clientes como Cherry-Studio, NextChat, Cline a la ruta correspondiente',
        'dashboard.routing.tip3': 'Llamadas entre protocolos: Soporta llamar modelos Claude con el protocolo OpenAI, u modelos OpenAI con el protocolo Claude',
        'dashboard.routing.nodeName.gemini': 'Gemini CLI OAuth',
        'dashboard.routing.nodeName.antigravity': 'Gemini Antigravity',
        'dashboard.routing.nodeName.claude': 'Claude Custom',
        'dashboard.routing.nodeName.kiro': 'Claude Kiro OAuth',
        ...
        'dashboard.routing.nodeName.codex': 'OpenAI Codex OAuth',
        'dashboard.routing.nodeName.grok': 'Grok Reverse',
        'dashboard.contact.title': 'Contacto y Donaciones',
        'dashboard.contact.wechat': 'Escanee para unirse al grupo, indique su propósito',
        'dashboard.contact.wechatDesc': 'Agregue WeChat para más soporte técnico e intercambio',
        'dashboard.contact.x': 'Siga X.com',
        'dashboard.contact.xDesc': 'Síganos en X para obtener las últimas noticias',
        'dashboard.contact.sponsor': 'Escanee para donate',
        'dashboard.contact.sponsorDesc': 'Su donación es el motor del desarrollo continuo del proyecto',
        'dashboard.contact.coffee': 'Buy me a coffee',
        'dashboard.contact.coffeeDesc': 'If you like this project, buy me a coffee!',
        
        // OAuth
        'oauth.modal.title': 'Autorización OAuth',
        'oauth.modal.provider': 'Proveedor:',
        'oauth.modal.requiredPort': 'Puerto necesario:',
        'oauth.modal.portNote': 'Asegúrese de que este puerto sea accesible desde el exterior para recibir el callback de autorización',
        'oauth.modal.steps': 'Pasos de autorización:',
        'oauth.modal.step1': 'Haga clic en el botón de abajo para abrir la página de autorización en el navegador',
        'oauth.modal.step2.qwen': 'Después de completar la autorización, el sistema obtendrá automáticamente el archivo de credenciales',
        'oauth.modal.step2.google': 'Inicie sesión con su cuenta de Google y autorice',
        'oauth.modal.step3': 'Los archivos de credenciales se pueden ver y gestionar en la gestión de configuración de carga',
        'oauth.modal.step4.qwen': 'Validez de la autorización: {min} minutos',
        'oauth.modal.step4.google': 'Después de completar la autorización, el archivo de credenciales se guardará automáticamente',
        'oauth.modal.urlLabel': 'Enlace de autorización:',
        'oauth.modal.copyTitle': 'Copiar',
        'oauth.modal.openInBrowser': 'Abrir en el Navegador',
        'oauth.manual.title': '¿La escucha automática está bloqueada?',
        'oauth.manual.desc': 'Si después de la redirección de la ventana de autorización muestra "No se puede acceder", pegue la <strong>URL completa</strong> de la barra de direcciones de esa ventana a continuación:',
        'oauth.manual.placeholder': 'Pegue la URL de callback (incluyendo code=...)',
        'oauth.manual.submit': 'Enviar',
        'oauth.success.msg': 'El enlace de autorización se ha copiado al portapapeles',
        'oauth.window.blocked': 'La ventana de autorización fue bloqueada por el navegador, permita ventanas emergentes',
        'oauth.window.opened': 'Se ha abierto la ventana de autorización, complete la operación en la ventana',
        'oauth.processing': 'Completando autorización...',
        'oauth.invalid.url': 'Esta URL parece no contener un código de autorización válido',
        'oauth.error.format': 'Formato de URL inválido',
        'oauth.kiro.selectMethod': 'Seleccionar método de autenticación',
        'oauth.kiro.google': 'Iniciar sesión con cuenta de Google',
        'oauth.kiro.googleDesc': 'Usar cuenta de Google para inicio de sesión social',
        'oauth.kiro.github': 'Iniciar sesión con cuenta de GitHub',
        'oauth.kiro.githubDesc': 'Usar cuenta de GitHub para inicio de sesión social',
        'oauth.kiro.awsBuilder': 'AWS Builder ID',
        'oauth.kiro.awsBuilderDesc': 'Usar AWS Builder ID para autorización con código de dispositivo',
        'oauth.kiro.authMethodLabel': 'Método de autenticación:',
        'oauth.kiro.step1': 'Haga clic en el botón de abajo para abrir el enlace de autorización en el navegador',
        'oauth.kiro.step2': 'Inicie sesión con su cuenta de {method}',
        'oauth.kiro.step3': 'Después de completar la autorización, la página se cerrará automáticamente',
        'oauth.kiro.step4': 'Actualice esta página para ver los archivos de credenciales',
        'oauth.kiro.batchImport': 'Importar Token Refresh de Google/Github en lote',
        'oauth.kiro.batchImportDesc': 'Importar en lote refreshTokens existentes para generar archivos de credenciales, este modo no es compatible con cuentas AWS.',
        'oauth.kiro.batchImportInstructions': 'Por favor ingrese el refreshToken, uno por línea. El sistema automáticamente actualizará y generará los archivos de credenciales.',
        'oauth.kiro.awsImport': 'Importar cuenta AWS',
        'oauth.kiro.awsImportDesc': 'Importar archivos de credenciales desde el directorio AWS SSO cache, aplicable al modo AWS Builder ID.',
        'oauth.kiro.awsImportInstructions': 'Por favor cargue los archivos JSON del directorio AWS SSO cache, que deben incluir los cuatro campos: clientId, clientSecret, accessToken, refreshToken. Si es un usuario empresarial de AWS, agregue el campo idcRegion.',
        'oauth.kiro.awsModeFile': 'Carga de Archivo',
        'oauth.kiro.awsModeJson': 'Pegar JSON',
        'oauth.kiro.awsUploadFiles': 'Cargar archivos de credenciales',
        'oauth.kiro.awsDragDrop': 'Arrastre archivos aquí',
        'oauth.kiro.awsClickUpload': 'O haga clic para seleccionar archivos',
        'oauth.kiro.awsFileHint': 'Si un archivo no contiene todos los campos, puede cargar varios archivos diferentes para completar',
        'oauth.kiro.awsSelectedFiles': 'Archivos seleccionados',
        'oauth.kiro.awsClearFiles': 'Limpiar todo',
        'oauth.kiro.awsFileReplaced': 'Archivo reemplazado: {filename}',
        'oauth.kiro.awsJsonInput': 'Pegar credenciales JSON',
        'oauth.kiro.awsJsonPlaceholderSimple': 'Pegue aquí el JSON que contiene clientId, clientSecret, accessToken, refreshToken...',
        'oauth.kiro.awsJsonExample': 'Ver ejemplo de formato JSON',
        'oauth.kiro.awsJsonHint': 'Puede pegar el JSON combinado directamente, o copiar el contenido desde los archivos AWS SSO cache',
        'oauth.kiro.awsJsonParseError': 'Formato JSON inválido',
        'oauth.kiro.awsParseError': 'Error al analizar el archivo {filename}',
        'oauth.kiro.awsValidationSuccess': '¡Validación exitosa! Se encontraron todos los campos requeridos',
        'oauth.kiro.awsValidationFailed': '¡Validación fallida! Faltan campos requeridos',
        'oauth.kiro.awsMissingFields': 'Faltan {count} campos',
        'oauth.kiro.awsUploadMore': 'Por favor cargue archivos con los campos faltantes, o cambie al modo JSON para completar manualmente',
        'oauth.kiro.awsPreviewJson': 'Vista previa de credenciales combinadas',
        'oauth.kiro.awsConfirmImport': 'Confirmar importación',
        'oauth.kiro.awsNoCredentials': 'No hay credenciales para importar',
        'oauth.kiro.awsImporting': 'Importando...',
        'oauth.kiro.awsImportSuccess': '¡Credenciales AWS importadas exitosamente!',
        'oauth.kiro.awsImportFailed': 'Error al importar credenciales AWS',
        'oauth.kiro.awsImportAllFailed': '¡Error en la importación! {count} credenciales fallidas',
        'oauth.kiro.refreshTokensLabel': 'Lista de RefreshTokens',
        'oauth.kiro.refreshTokensPlaceholder': 'Ingrese un refreshToken por línea\nPor ejemplo:\naorAxxxxxxxx\naorAyyyyyyyy\naorAzzzzzzzz',
        'oauth.kiro.tokenCount': 'Cantidad a importar:',
        'oauth.kiro.importing': 'Importando, por favor espere...',
        'oauth.kiro.importingProgress': 'Importando {current}/{total}...',
        'oauth.kiro.startImport': 'Iniciar importación',
        'oauth.kiro.noTokens': 'Por favor ingrese al menos un refreshToken',
        'oauth.kiro.importSuccess': '¡Importación exitosa! Se generaron {count} credenciales',
        'oauth.kiro.importAllFailed': '¡Error en la importación! {count} tokens fallidos al actualizar',
        'oauth.kiro.importPartial': 'Parcialmente exitoso: {success} exitosos, {failed} fallidos',
        'oauth.kiro.importError': 'Error en la importación',
        'oauth.kiro.duplicateToken': 'Credencial duplicada - este refreshToken ya existe',
        'oauth.gemini.selectMethod': 'Seleccionar método de autorización',
        'oauth.gemini.oauth': 'Autorización OAuth',
        'oauth.gemini.oauthDesc': 'Autorización OAuth estándar a través de cuenta de Google',
        'oauth.gemini.batchImport': 'Importación en lote',
        'oauth.gemini.batchImportDesc': 'Importar en lote múltiples datos de Token JSON',
        'oauth.gemini.tokensLabel': 'Datos de Token (Arreglo JSON)',
        'oauth.gemini.tokensPlaceholder': 'Pegue el arreglo JSON que contiene access_token y refresh_token...',
        'oauth.gemini.importInstructions': 'Pegue los datos de Token JSON obtenidos del navegador o CLI. Soporta un solo objeto o un arreglo de objetos.',
        'oauth.gemini.noTokens': 'Por favor ingrese datos de Token válidos',
        'oauth.gemini.importing': 'Importando...',
        'oauth.gemini.importingProgress': 'Procesando: {current} / {total}',
        'oauth.gemini.importSuccess': '{count} credenciales importadas exitosamente',
        'oauth.gemini.importAllFailed': 'Las {count} credenciales fallaron en la importación',
        'oauth.gemini.importPartial': 'Importación parcial exitosa: {success} exitosos, {failed} fallidos',
        'oauth.gemini.importError': 'Error durante la importación',
        'oauth.gemini.tokenCount': 'Cantidad de Tokens',
        'oauth.gemini.startImport': 'Iniciar importación',
        'oauth.gemini.jsonExample': 'Ver ejemplo de formato JSON',
        'oauth.gemini.jsonHint': 'Asegúrese de que el JSON contenga access_token y refresh_token',
        'oauth.codex.batchImport': 'Importar Codex Token en lote',
        'oauth.codex.batchImportDesc': 'Importar en lote múltiples datos de Codex Token JSON',
        'oauth.codex.tokensLabel': 'Datos de Token (Arreglo JSON)',
        'oauth.codex.tokensPlaceholder': 'Pegue el arreglo JSON que contiene access_token y id_token...',
        'oauth.codex.importInstructions': 'Pegue los datos de Codex Token JSON obtenidos del navegador o CLI. Soporta un solo objeto o un arreglo de objetos.',
        'oauth.codex.noTokens': 'Por favor ingrese datos de Token válidos',
        'oauth.codex.importing': 'Importando...',
        'oauth.codex.importingProgress': 'Procesando: {current} / {total}',
        'oauth.codex.importSuccess': '{count} credenciales importadas exitosamente',
        'oauth.codex.importAllFailed': 'Las {count} credenciales fallaron en la importación',
        'oauth.codex.importPartial': 'Importación parcial exitosa: {success} exitosos, {failed} fallidos',
        'oauth.codex.importError': 'Error durante la importación',
        'oauth.codex.tokenCount': 'Cantidad de Tokens',
        'oauth.codex.startImport': 'Iniciar importación',
        'oauth.codex.jsonExample': 'Ver ejemplo de formato JSON',
        'oauth.codex.jsonHint': 'Asegúrese de que el JSON contenga access_token y id_token',
        'oauth.kiro.duplicateCredentials': 'Esta credencial ya existe, no importa de nuevo',
        'oauth.kiro.builderIDStartURL': 'Builder ID Start URL',
        'oauth.kiro.builderIDStartURLHint': 'Si usa AWS IAM Identity Center, ingrese su Start URL',
        'oauth.iflow.step1': 'Haga clic en el botón de abajo para abrir la página de autorización de iFlow en el navegador',
        'oauth.iflow.step2': 'Inicie sesión con su cuenta de iFlow y autorice',
        'oauth.iflow.step3': 'Después de completar la autorización, el sistema obtendrá automáticamente la API Key',
        'oauth.iflow.step4': 'Los archivos de credenciales se pueden ver y gestionar en la gestión de configuración de carga',

        // Config
        'config.title': 'Gestión de Configuración',
        'config.apiKey': 'Clave API',
        'config.apiKey.generate': 'Generar',
        'config.apiKey.generateTitle': 'Generar clave API automáticamente',
        'config.apiKey.generated': 'Nueva clave API generada',
        'config.apiKeyPlaceholder': 'Por favor ingrese la clave API',
        'config.host': 'Dirección de escucha',
        'config.hostPlaceholder': 'Por ejemplo: 127.0.0.1',
        'config.port': 'Puerto',
        'config.portPlaceholder': '3000',
        'config.basic.title': 'Configuración Básica',
        'config.governance.title': 'Gobernanza del Servicio',
        'config.oauth.title': 'OAuth y Token',
        'config.modelProvider': 'Proveedores de modelo precargados',
        'config.modelProviderHelp': 'Seleccione los adaptadores que se inicializarán al iniciar el servicio para acelerar la primera solicitud y garantizar el enrutamiento disponible (debe seleccionar al menos uno)',
        'config.modelProviderRequired': 'Debe seleccionar al menos un proveedor precargado',
        'config.pin': 'Establecer como predeterminado (fijar arriba)',
        'config.optional': '(Opcional)',
        'config.gemini.baseUrl': 'Gemini Base URL',
        'config.gemini.baseUrlPlaceholder': 'https://cloudcode-pa.googleapis.com',
        'config.gemini.projectId': 'ID del Proyecto',
        'config.gemini.projectIdPlaceholder': 'ID del proyecto de Google Cloud',
        'config.gemini.oauthCreds': 'Credenciales OAuth',
        'config.gemini.credsType.file': 'Ruta del archivo',
        'config.gemini.credsType.base64': 'Codificación Base64',
        'config.gemini.credsBase64': 'Credenciales OAuth (Base64)',
        'config.gemini.credsBase64Placeholder': 'Ingrese las credenciales OAuth codificadas en Base64',
        'config.gemini.credsFilePath': 'Ruta del archivo de credenciales OAuth',
        'config.gemini.credsFilePathPlaceholder': 'Por ejemplo: ~/.gemini/oauth_creds.json',
        'config.antigravity.dailyUrl': 'Daily Base URL',
        'config.antigravity.dailyUrlPlaceholder': 'https://daily-cloudcode-pa.sandbox.googleapis.com',
        'config.antigravity.autopushUrl': 'Autopush Base URL',
        'config.antigravity.autopushUrlPlaceholder': 'https://autopush-cloudcode-pa.sandbox.googleapis.com',
        'config.antigravity.credsFilePath': 'Ruta del archivo de credenciales OAuth',
        'config.antigravity.credsFilePathPlaceholder': 'Por ejemplo: ~/.antigravity/oauth_creds.json',
        'config.antigravity.note': 'Antigravity usa autenticación Google OAuth, necesita proporcionar la ruta del archivo de credenciales',
        'config.openai.apiKey': 'OpenAI API Key',
        'config.openai.apiKeyPlaceholder': 'sk-...',
        'config.openai.baseUrl': 'OpenAI Base URL',
        'config.openai.baseUrlPlaceholder': 'Por ejemplo: https://api.openai.com/v1',
        'config.claude.apiKey': 'Claude API Key',
        'config.claude.apiKeyPlaceholder': 'sk-ant-...',
        'config.claude.baseUrl': 'Claude Base URL',
        'config.claude.baseUrlPlaceholder': 'Por ejemplo: https://api.anthropic.com',
        'config.kiro.baseUrl': 'Base URL',
        'config.kiro.baseUrlPlaceholder': 'https://codewhisperer.{{region}}.amazonaws.com/generateAssistantResponse',
        'config.kiro.refreshUrl': 'Refresh URL',
        'config.kiro.refreshUrlPlaceholder': 'https://prod.{{region}}.auth.desktop.kiro.dev/refreshToken',
        'config.kiro.refreshIdcUrl': 'Refresh IDC URL',
        'config.kiro.refreshIdcUrlPlaceholder': 'https://oidc.{{region}}.amazonaws.com/token',
        'config.kiro.credsFilePath': 'Ruta del archivo de credenciales OAuth',
        'config.kiro.credsFilePathPlaceholder': 'Por ejemplo: ~/.aws/sso/cache/kiro-auth-token.json',
        'config.kiro.note': 'Al usar el método de inicio de sesión AWS, asegúrese de que el archivo de autorización contenga los campos clientId y clientSecret',
        'config.qwen.baseUrl': 'Qwen Base URL',
        'config.qwen.baseUrlPlaceholder': 'https://portal.qwen.ai/v1',
        'config.qwen.oauthBaseUrl': 'OAuth Base URL',
        'config.qwen.oauthBaseUrlPlaceholder': 'https://chat.qwen.ai',
        'config.qwen.credsFilePath': 'Ruta del archivo de credenciales OAuth',
        'config.qwen.credsFilePathPlaceholder': 'Por ejemplo: ~/.qwen/oauth_creds.json',
        'config.advanced.title': 'Configuración Avanzada',
        'config.advanced.systemPromptFile': 'Ruta del archivo de prompt del sistema',
        'config.advanced.systemPromptFilePlaceholder': 'Por ejemplo: configs/input_system_prompt.txt',
        'config.advanced.systemPromptMode': 'Modo de prompt del sistema',
        'config.advanced.systemPromptMode.append': 'Agregar (append)',
        'config.advanced.systemPromptMode.overwrite': 'Sobrescribir (overwrite)',
        'config.advanced.promptLogBaseName': 'Nombre base del log de prompts',
        'config.advanced.promptLogBaseNamePlaceholder': 'Por ejemplo: prompt_log',
        'config.advanced.promptLogMode': 'Modo de log de prompts',
        'config.advanced.promptLogMode.none': 'Ninguno (none)',
        'config.advanced.promptLogMode.console': 'Consola (console)',
        'config.advanced.promptLogMode.file': 'Archivo (file)',
        'config.advanced.maxRetries': 'Máximo de reintentos dentro del proveedor',
        'config.advanced.baseDelay': 'Retraso base de reintentos (milisegundos)',
        'config.advanced.credentialSwitchMaxRetries': 'Máximo de reintentos al cambiar credenciales',
        'config.advanced.credentialSwitchMaxRetriesNote': 'Máximo de reintentos para cambiar credenciales después de errores de autenticación (401/403), por defecto 5 veces',
        'config.advanced.warmupTarget': 'Número de nodos de calentamiento del sistema',
        'config.advanced.warmupTargetNote': 'Cantidad de nodos que se actualizan automáticamente al iniciar el sistema, por defecto 0',
        'config.advanced.refreshConcurrencyPerProvider': 'Concurrencia de actualización por proveedor',
        'config.advanced.refreshConcurrencyPerProviderNote': 'Cantidad máxima de tareas de actualización paralelo dentro de cada proveedor, por defecto 1',
        'config.advanced.cronInterval': 'Intervalo de actualización de tokens OAuth (minutos)',
        'config.advanced.cronEnabled': 'Habilitar actualización automática de tokens OAuth (requiere reiniciar el servicio)',
        'config.advanced.loginExpiry': 'Tiempo de expiración del inicio de sesión (segundos)',
        'config.advanced.loginExpiryNote': 'Validez del Token después del inicio de sesión del panel de administración, por defecto 3600 segundos (1 hora)',
        'config.advanced.poolFilePath': 'Ruta del archivo de configuración del grupo de proveedores (no puede estar vacío)',
        'config.advanced.poolFilePathPlaceholder': 'Por defecto: configs/provider_pools.json',
        'config.advanced.poolNote': 'Si usa la configuración de autorización predeterminada del cliente, use nodos vacíos',
        'config.advanced.maxErrorCount': 'Máximo de errores por proveedor',
        'config.advanced.maxErrorCountPlaceholder': 'Por defecto: 10',
        'config.advanced.maxErrorCountNote': 'El proveedor se marcará como no saludable después de alcanzar este número de errores consecutivos, por defecto 10 veces',
        'config.advanced.poolSizeLimit': 'Límite superior del grupo de cuentas',
        'config.advanced.poolSizeLimitPlaceholder': 'Por defecto: 0 (sin límite)',
        'config.advanced.poolSizeLimitNote': 'Cantidad máxima de credenciales saludables que participan en el轮询 para cada tipo de proveedor, 0 significa sin límite, usa todas las credenciales saludables',
        'config.advanced.fallbackChain': 'Configuración de cadena de Fallback entre tipos',
        'config.advanced.fallbackChainPlaceholder': 'Por ejemplo:\n{\n  "gemini-cli-oauth": ["gemini-antigravity"],\n  "gemini-antigravity": ["gemini-cli-oauth"],\n  "claude-kiro-oauth": ["claude-custom"]\n}',
        'config.advanced.fallbackChainNote': 'Cuando todas las cuentas de un tipo de proveedor no están saludables, cambia automáticamente al tipo de Fallback configurado. Formato JSON, la clave es el tipo principal, el valor es un arreglo de tipos de Fallback (ordenados por prioridad)',
        'config.advanced.fallbackChainInvalid': 'Formato de configuración de cadena de Fallback inválido, por favor ingrese un JSON válido',
        'config.advanced.modelFallbackMapping': 'Mapeo de Fallback de modelo entre protocolos',
        'config.advanced.modelFallbackMappingPlaceholder': 'Por ejemplo:\n{\n  "gemini-claude-opus-4-5-thinking": {\n    "targetProviderType": "claude-kiro-oauth",\n    "targetModel": "claude-opus-4-5"\n  }\n}',
        'config.advanced.modelFallbackMappingNote': 'Cuando el proveedor principal no está disponible, mapea a otro protocolo de proveedor y modelo según el nombre del modelo. Prioridad menor que la configuración de cadena de Fallbox acima. Formato JSON.',
        'config.advanced.modelFallbackMappingInvalid': 'Formato de configuración de mapeo de Fallback de modelo inválido, por favor ingrese un JSON válido',
        'config.advanced.systemPrompt': 'Prompt del sistema',
        'config.advanced.systemPromptPlaceholder': 'Ingrese el prompt del sistema...',
        'config.advanced.systemPromptReplacements': 'Reemplazos del contenido del prompt del sistema',
        'config.advanced.systemPromptReplacementsNote': 'Ejecutar reemplazos de contenido en el prompt del sistema (incluyendo el de las solicitudes y archivos) en orden.',
        'config.advanced.replacement.old': 'Buscar contenido (viejo)',
        'config.advanced.replacement.new': 'Reemplazar contenido (nuevo)',
        'config.advanced.replacement.add': 'Agregar regla de reemplazo',
        'config.advanced.replacement.remove': 'Eliminar',
        'config.advanced.adminPassword': 'Contraseña de administración',
        'config.advanced.adminPasswordPlaceholder': 'Establecer contraseña de administración (dejar vacío para no modificar)',
        'config.advanced.adminPasswordNote': 'Se usa para proteger el acceso a la consola de administración, se requiere iniciar sesión nuevamente después de modificar',
        'config.proxy.title': 'Configuración de Proxy',
        'config.proxy.url': 'Dirección del proxy',
        'config.proxy.urlPlaceholder': 'Por ejemplo: http://127.0.0.1:7890 o socks5://127.0.0.1:1080',
        'config.proxy.urlNote': 'Soporta proxy HTTP, HTTPS y SOCKS5, déjelo vacío para no usar proxy',
        'config.proxy.enabledProviders': 'Proveedores con proxy habilitado',
        'config.proxy.enabledProvidersNote': 'Seleccione los proveedores que necesitan acceder a través del proxy, los no seleccionados se conectarán directamente',
        'config.proxy.tlsSidecarEnabled': 'Suplantación de huella TLS (uTLS Sidecar)',
        'config.proxy.tlsSidecarPort': 'Puerto del Sidecar',
        'config.proxy.tlsSidecarProxyUrl': 'Proxy upstream del Sidecar',
        'config.proxy.tlsSidecarEnabledProviders': 'Proveedores con TLS Sidecar habilitado',
        'config.proxy.tlsSidecarNote': 'Cuando está habilitado, las solicitudes de los proveedores seleccionados se reenviarán a través del sidecar Go uTLS, simulando perfectamente la huella TLS/H2 de Chrome para evadir Cloudflare (requiere reiniciar el servicio)',
        'config.healthCheck.title': 'Verificación de salud programada',
        'config.healthCheck.enabled': 'Habilitar verificación programada',
        'config.healthCheck.startupRun': 'Ejecutar al iniciar',
        'config.healthCheck.interval': 'Intervalo de verificación',
        'config.healthCheck.intervalNote': 'En milisegundos, mínimo 60000ms (1 minuto), máximo 3600000ms (1 hora), puede ingresar manualmente o hacer clic en los botones de acceso directo',
        'config.healthCheck.providerTypes': 'Proveedores para verificación programada',
        'config.healthCheck.providerTypesNote': 'Seleccione los tipos de proveedores que necesitan verificación de salud programada, déjelo vacío para no realizar ninguna verificación',
        'config.log.title': 'Configuración de Logs',
        'config.log.enabled': 'Habilitar logs',
        'config.log.outputMode': 'Modo de salida de logs',
        'config.log.outputMode.all': 'Todo (consola+archivo)',
        'config.log.outputMode.console': 'Solo consola',
        'config.log.outputMode.file': 'Solo archivo',
        'config.log.outputMode.none': 'Deshabilitar',
        'config.log.level': 'Nivel de logs',
        'config.log.level.debug': 'Depuración (debug)',
        'config.log.level.info': 'Información (info)',
        'config.log.level.warn': 'Advertencia (warn)',
        'config.log.level.error': 'Error (error)',
        'config.log.dir': 'Directorio de logs',
        'config.log.dirPlaceholder': 'Por ejemplo: logs',
        'config.log.includeRequestId': 'Incluir ID de solicitud',
        'config.log.includeTimestamp': 'Incluir marca de tiempo',
        'config.log.maxFileSize': 'Tamaño máximo del archivo (bytes)',
        'config.log.maxFileSizeNote': 'Por defecto 10MB (10485760 bytes)',
        'config.log.maxFiles': 'Máximo de archivos a mantener',
        'config.log.maxFilesNote': 'Cantidad de archivos de log recientes a mantener',
        'config.save': 'Guardar configuración',
        'config.reset': 'Restablecer',
        'config.placeholder.nodeName': 'Por ejemplo: Mi nodo 1',
        'config.placeholder.model': 'Por ejemplo: gpt-3.5-turbo',
        
        // Upload Config
        'upload.title': 'Gestión de Archivos de Credenciales',
        'upload.search': 'Buscar configuración',
        'upload.searchPlaceholder': 'Ingrese el nombre del archivo',
        'upload.providerFilter': 'Tipo de proveedor',
        'upload.providerFilter.all': 'Todos los proveedores',
        'upload.providerFilter.kiro': 'Kiro OAuth',
        'upload.providerFilter.gemini': 'Gemini OAuth',
        'upload.providerFilter.qwen': 'Qwen OAuth',
        'upload.providerFilter.antigravity': 'Antigravity',
        ...
        'upload.providerFilter.iflow': 'iFlow OAuth',
        'upload.providerFilter.grok': 'Grok Reverse',
        'upload.providerFilter.other': 'Otros/No reconocido',
        'upload.statusFilter': 'Estado de asociación',
        'upload.statusFilter.all': 'Todos los estados',
        'upload.statusFilter.used': 'Asociado',
        'upload.statusFilter.unused': 'No asociado',
        'upload.refresh': 'Actualizar',
        'upload.downloadAll': 'Descargar como ZIP',
        'upload.listTitle': 'Lista de archivos de configuración',
        'upload.count': 'Total de {count} archivos de configuración',
        'upload.usedCount': 'Asociados: {count}',
        'upload.unusedCount': 'No asociados: {count}',
        'upload.batchLink': 'Asociar oauth automáticamente',
        'upload.noConfigs': 'No se encontraron archivos de configuración coincidentes',
        'upload.detail.path': 'Ruta del archivo',
        'upload.detail.size': 'Tamaño del archivo',
        'upload.detail.modified': 'Última modificación',
        'upload.detail.status': 'Estado de asociación',
        'upload.action.view': 'Ver',
        'upload.action.download': 'Descargar',
        'upload.action.delete': 'Eliminar',
        'upload.usage.title': 'Detalles de asociación ({type})',
        'upload.usage.mainConfig': 'Configuración principal',
        'upload.usage.providerPool': 'Grupo de proveedores',
        'upload.usage.multiple': 'Múltiples propósitos',
        'upload.delete.confirmTitle': 'Eliminar archivo de configuración',
        'upload.delete.confirmTitleUsed': 'Eliminar configuración asociada',
        'upload.delete.warningUsedTitle': '⚠️ Esta configuración está siendo usada por el sistema',
        'upload.delete.warningUsedDesc': 'Eliminar archivos de configuración asociados puede afectar el funcionamiento normal del sistema. Asegúrese de comprender las consecuencias de la eliminación.',
        'upload.delete.warningUnusedTitle': '🗑️ Confirmar eliminación de archivo de configuración',
        'upload.delete.warningUnusedDesc': 'Esta acción eliminará permanentemente el archivo de configuración y no se puede deshacer.',
        'upload.delete.fileName': 'Nombre del archivo:',
        'upload.delete.usageAlertTitle': 'Detalles de uso',
        'upload.delete.usageAlertDesc': 'Este archivo de configuración está siendo usado por el sistema, eliminarlo puede causar:',
        'upload.delete.usageAlertItem1': 'Los servicios de IA relacionados no funcionarán correctamente',
        'upload.delete.usageAlertItem2': 'La configuración en la gestión de configuración perderá efecto',
        'upload.delete.usageAlertItem3': 'Se perderá la configuración del grupo de proveedores',
        'upload.delete.usageAlertAdvice': '<strong>Recomendación:</strong> Primero desasocie las referencias de archivos en la gestión de configuración antes de eliminar.',
        'upload.delete.forceDelete': 'Forzar eliminación',
        'upload.delete.confirmDelete': 'Confirmar eliminación',
        'upload.batchLink.confirm': '¿Está seguro de que desea asociar en lote {count} configuraciones?\n\n{summary}',
        'upload.refresh.success': 'Actualización exitosa',
        'upload.action.view.failed': 'Error al ver',
        'upload.action.delete.failed': 'Error al eliminar',
        'upload.action.quickLink': 'Asociación con un clic',
        'upload.config.notExist': 'El archivo de configuración no existe',
        'upload.link.identifying': 'Identificando tipo de proveedor...',
        'upload.link.failed.identify': 'No se puede identificar el tipo de proveedor del archivo de configuración',
        'upload.link.processing': 'Asociando configuración a {name}...',
        'upload.link.success': 'Configuración asociada exitosamente',
        'upload.link.failed': 'Error en la asociación',
        'upload.batchLink.none': 'No hay archivos de configuración para asociar',
        'upload.batchLink.processing': 'Asociando en lote {count} configuraciones...',
        'upload.batchLink.success': '{count} configuraciones asociadas exitosamente',
        'upload.batchLink.partial': 'Asociación completada: {success} exitosas, {fail} fallidas',
        'upload.deleteUnbound': 'Eliminar no asociados',
        'upload.deleteUnbound.none': 'No hay archivos de configuración no asociados para eliminar (solo elimina archivos en configs/subdir/)',
        'upload.deleteUnbound.confirm': '¿Está seguro de que desea eliminar {count} archivos de configuración no asociados?\n\nNota: Solo elimina archivos no asociados en configs/subdir/, los archivos en la raíz de configs/ no se eliminarán.\n\n¡Esta acción no se puede deshacer!',
        'upload.deleteUnbound.processing': 'Eliminando archivos de configuración no asociados...',
        'upload.deleteUnbound.success': '{count} archivos de configuración no asociados eliminados exitosamente',
        'upload.deleteUnbound.partial': 'Eliminación completada: {success} exitosos, {fail} fallidos',
        'upload.deleteUnbound.failed': 'Error al eliminar configuraciones no asociadas',
        
        // Providers
        'providers.title': 'Gestión de Grupos de Proveedores',
        'providers.addGroup': 'Nuevo grupo',
        'providers.addGroup.title': 'Agregar nuevo grupo',
        'providers.addGroup.success': 'Grupo creado exitosamente, por favor agregue cuentas',
        'providers.addGroup.error': 'Error al crear',
        'providers.addGroup.suffix': 'Nombre del grupo (sufijo)',
        'providers.addGroup.suffixPlaceholder': 'Por ejemplo: qwen, glm, minimax',
        'providers.note': 'Si usa la configuración de autorización predeterminada del cliente, use nodos vacíos',
        'providers.activeConnections': 'Conexiones activas',
        'providers.activeProviders': 'Proveedores activos',
        'providers.healthyProviders': 'Proveedores saludables',
        'providers.status.healthy': '{healthy}/{total} disponibles',
        'providers.status.empty': '0/0 nodos',
        'providers.status.needsRefresh': 'Actualizando',
        'providers.stat.totalAccounts': 'Cuentas totales',
        'providers.stat.healthyAccounts': 'Cuentas saludables',
        'providers.stat.usageCount': 'Usos',
        'providers.stat.errorCount': 'Errores',
        'providers.auth.generate': 'Generar autorización',
        'providers.auth.importToken': 'Importar Token',

        // Modal Provider Manager
        'modal.provider.manage': 'Gestionar configuración del proveedor {type}',
        'modal.provider.totalAccounts': 'Total de cuentas:',
        'modal.provider.healthyAccounts': 'Cuentas saludables:',
        'modal.provider.add': 'Agregar nuevo proveedor',
        'modal.provider.resetHealth': 'Restablecer a saludable',
        'modal.provider.healthCheck': 'Verificar no saludables',
        'modal.provider.resetHealthConfirm': '¿Está seguro de que desea restablecer todos los nodos de {type} a estado saludable?\n\nEsto borrará el conteo de errores y el tiempo de error de todos los nodos.',
        'modal.provider.healthCheckConfirm': '¿Está seguro de que desea ejecutar verificación de salud en los nodos no saludables de {type}?\n\nEsto enviará solicitudes de prueba a los nodos no saludables para verificar su disponibilidad.',
        'modal.provider.deleteConfirm': '¿Está seguro de que desea eliminar esta configuración de proveedor? Esta acción no se puede recuperar.',
        'modal.provider.disableConfirm': '¿Está seguro de que desea deshabilitar esta configuración de proveedor? Después de deshabilitar, este proveedor no será seleccionado para uso.',
        'modal.provider.enableConfirm': '¿Está seguro de que desea habilitar esta configuración de proveedor?',
        'modal.provider.edit': 'Editar',
        'modal.provider.delete': 'Eliminar',
        'modal.provider.save': 'Guardar',
        'modal.provider.cancel': 'Cancelar',
        'modal.provider.status.healthy': 'Normal',
        'modal.provider.status.unhealthy': 'Anormal',
        'modal.provider.status.disabled': 'Deshabilitado',
        'modal.provider.status.enabled': 'Habilitado',
        'modal.provider.lastError': 'Último error:',
        'modal.provider.lastUsed': 'Último uso:',
        'modal.provider.lastCheck': 'Última verificación:',
        'modal.provider.checkModel': 'Verificar modelo:',
        'modal.provider.concurrencyLimit': 'Límite de concurrencia',
        'modal.provider.queueLimit': 'Límite de cola',
        'modal.provider.usageCount': 'Usos:',
        'modal.provider.errorCount': 'Fallos:',
        'modal.provider.neverUsed': 'Nunca usado',
        'modal.provider.neverChecked': 'Nunca verificado',
        'modal.provider.noModels': 'No hay lista de modelos disponibles para este tipo de proveedor',
        'modal.provider.loadingModels': 'Cargando lista de modelos...',
        'modal.provider.unsupportedModels': 'Modelos no soportados',
        'modal.provider.unsupportedModelsHelp': 'Seleccione modelos que este proveedor no soporta, el sistema automáticamente excluirá estos modelos',
        'modal.provider.supportedModels': 'Lista de modelos',
        'modal.provider.supportedModelsHelp': 'Solo mantenga los modelos que desea que use este nodo, también puede seleccionar modelos de verificación de salud desde aquí',
        'modal.provider.supportedModelsEmpty': 'No ha seleccionado modelos aún. Puede hacer clic en "Detectar modelos disponibles" después de editar para obtener la lista de candidatos.',
        'modal.provider.detectModels': 'Detectar modelos disponibles',
        'modal.provider.detectModelsFailed': 'Error al detectar modelos disponibles',
        'modal.provider.detectModelsNoResults': 'No se detectaron modelos disponibles',
        'modal.provider.modelPickerTitle': 'Modelos disponibles de {type}',
        'modal.provider.modelPickerSearchPlaceholder': 'Buscar nombre del modelo',
        'modal.provider.modelPickerSelectAll': 'Seleccionar todo los resultados actuales',
        'modal.provider.modelPickerClearAll': 'Limpiar selección',
        'modal.provider.modelPickerSelected': '{count} modelos seleccionados',
        'modal.provider.addTitle': 'Agregar nueva configuración de proveedor',
        'modal.provider.customName': 'Nombre personalizado',
        'modal.provider.checkModelName': 'Verificar nombre del modelo',
        'modal.provider.healthCheckLabel': 'Verificación de salud',
        'modal.provider.enabled': 'Habilitado',
        'modal.provider.disabled': 'Deshabilitado',
        'modal.provider.noProviderType': 'Tipo de proveedor no soportado',
        'modal.provider.refreshUuid': 'Actualizar uuid',
        'modal.provider.refreshUuidConfirm': '¿Está seguro de que desea actualizar el uuid de este proveedor?\n\nUuid anterior: {oldUuid}\n\nDespués de actualizar, se generará un nuevo uuid, asegúrese de que no haya otras dependencias del sistema en este uuid.',
        'modal.provider.refreshUuid.success': 'Uuid actualizado exitosamente\n\nUuid anterior: {oldUuid}\nNuevo uuid: {newUuid}',
        'modal.provider.refreshUuid.failed': 'Error al actualizar uuid',
        'modal.provider.field.projectId': 'ID del Proyecto',
        'modal.provider.field.oauthPath': 'Ruta del archivo de credenciales OAuth',
        'modal.provider.field.baseUrl': 'Base URL',
        'modal.provider.field.refreshUrl': 'Refresh URL',
        'modal.provider.field.refreshIdcUrl': 'Refresh IDC URL',
        'modal.provider.field.oauthBaseUrl': 'OAuth Base URL',
        'modal.provider.field.dailyBaseUrl': 'Daily Base URL',
        'modal.provider.field.autopushBaseUrl': 'Autopush Base URL',
        'modal.provider.field.headerName': 'Nombre del Header',
        'modal.provider.field.headerPrefix': 'Prefijo del valor del Header',
        'modal.provider.field.useSystemProxy': 'Usar proxy del sistema',
        'modal.provider.field.ssoToken': 'SSO Token (Cookie)',
        'modal.provider.field.cfClearance': 'CF Clearance (Cookie)',
        'modal.provider.field.userAgent': 'User-Agent (huella del navegador)',
        'modal.provider.field.iflowBaseUrl': 'iFlow Base URL',
        'modal.provider.field.grokBaseUrl': 'Grok Base URL',
        'modal.provider.field.codexBaseUrl': 'Codex Base URL',
        'modal.provider.field.apiKey': 'Clave API',
        'modal.provider.field.apiKey.placeholder': 'Por favor ingrese la clave API',
        'modal.provider.field.projectId.placeholder': 'ID del proyecto de Google Cloud (vacío para auto-detectar)',
        'modal.provider.field.projectId.optional.placeholder': 'ID del proyecto de Google Cloud (vacío para auto-detectar)',
        'modal.provider.field.oauthPath.gemini.placeholder': 'Por ejemplo: ~/.gemini/oauth_creds.json',
        'modal.provider.field.oauthPath.kiro.placeholder': 'Por ejemplo: ~/.aws/sso/cache/kiro-auth-token.json',
        'modal.provider.field.oauthPath.qwen.placeholder': 'Por ejemplo: ~/.qwen/oauth_creds.json',
        'modal.provider.field.oauthPath.antigravity.placeholder': 'Por ejemplo: ~/.antigravity/oauth_creds.json',
        'modal.provider.field.oauthPath.iflow.placeholder': 'Por ejemplo: configs/iflow/oauth_creds.json',
        'modal.provider.field.oauthPath.codex.placeholder': 'Por ejemplo: configs/codex/oauth_creds.json',
        'modal.provider.field.email': 'Correo electrónico',
        'modal.provider.field.email.placeholder': 'tu@email.com',

        'modal.provider.load.failed': 'Error al cargar los detalles del proveedor',
        'modal.provider.auth.initializing': 'Inicializando generación de credenciales...',
        'modal.provider.auth.success': 'Credenciales generadas y ruta completada automáticamente',
        'modal.provider.auth.window': 'Por favor complete la autorización en la ventana abierta',
        'modal.provider.auth.failed': 'Error al inicializar la generación de credenciales',
        'modal.provider.save.success': 'Guardado exitosamente',
        'modal.provider.save.failed': 'Error al guardar',
        'modal.provider.delete.success': 'Eliminado exitosamente',
        'modal.provider.delete.failed': 'Error al eliminar',
        'modal.provider.add.success': 'Agregado exitosamente',
        'modal.provider.add.failed': 'Error al agregar',
        'modal.provider.resetHealth.success': '{count} nodos restablecidos a estado saludable',
        'modal.provider.resetHealth.failed': 'Error al restablecer el estado saludable',
        'modal.provider.deleteUnhealthy': 'Eliminar nodos no saludables',
        'modal.provider.deleteUnhealthyBtn': 'Eliminar no saludables',
        'modal.provider.deleteUnhealthyConfirm': '¿Está seguro de que desea eliminar {count} nodos no saludables? Esta acción no se puede recuperar.',
        'modal.provider.deleteUnhealthy.noUnhealthy': 'No hay nodos no saludables',
        'modal.provider.deleteUnhealthy.deleting': 'Eliminando...',
        'modal.provider.deleteUnhealthy.success': '{count} nodos eliminados',
        'modal.provider.deleteUnhealthy.failed': 'Error al eliminar',
        'modal.provider.healthCheck.complete': 'Verificación de salud completada: {success} se volvieron saludables',
        'modal.provider.healthCheck.abnormal': ', {fail} anormales',
        'modal.provider.healthCheck.skipped': ', {skipped} omitidos (no habilitados)',
        'modal.provider.refreshUnhealthyUuids': 'Actualizar UUIDs no saludables',
        'modal.provider.refreshUnhealthyUuidsBtn': 'Actualizar UUIDs',
        'modal.provider.refreshUnhealthyUuidsConfirm': '¿Está seguro de que desea actualizar los UUIDs de {count} nodos no saludables?',
        'modal.provider.refreshUnhealthyUuids.noUnhealthy': 'No hay nodos no saludables',
        'modal.provider.refreshUnhealthyUuids.refreshing': 'Actualizando...',
        'modal.provider.refreshUnhealthyUuids.success': '{count} nodos actualizados',
        'modal.provider.refreshUnhealthyUuids.failed': 'Error al actualizar',
        'modal.provider.kiroAuthHint': 'Al usar el método de inicio de sesión AWS Builder ID, necesita los campos <code>clientId</code> y <code>clientSecret</code>, que pueden obtenerse de otro archivo JSON en la misma carpeta',
        
        'modal.provider.healthCheckCurrentTitle': 'Ejecutar una verificación de salud inmediatamente en el nodo actual',
        'modal.provider.healthCheckSingleSuccess': 'Verificación de salud exitosa',
        'modal.provider.healthCheckSingleSuccessWithModel': 'Verificación de salud exitosa, usando modelo: {model}',
        'modal.provider.healthCheckSingleFailed': 'Verificación de salud fallida: {message}',

        // Pagination
        'pagination.showing': 'Mostrando {start}-{end} / {total} total',
        'pagination.jumpTo': 'Ir a',
        'pagination.page': 'página',
        
        // Usage
        'usage.title': 'Consulta de Uso',
        'usage.refresh': 'Actualizar uso',
        'usage.serverTime': 'Hora del servidor',
        'usage.lastUpdate': 'Última actualización: {time}',
        'usage.lastUpdateCache': 'Tiempo de caché: {time}',
        'usage.supportedProvidersPrefix': 'Proveedores que soportan consulta de uso:',
        'usage.loading': 'Cargando datos de uso...',
        'usage.empty': 'Haga clic en el botón "Actualizar uso" para obtener información de uso de los archivos de autorización',
        'usage.noData': 'No hay datos de uso disponibles',
        'usage.noInstances': 'No hay instancias de servicio inicializadas',
        'usage.group.instances': '{count} instancias',
        'usage.group.success': '{count}/{total} exitosos',
        'usage.card.status.disabled': 'Deshabilitado',
        'usage.card.status.healthy': 'Saludable',
        'usage.card.status.unhealthy': 'Anormal',
        'usage.card.totalUsage': 'Uso total',
        'usage.card.resetAt': 'Se restablecerá en {time}',
        'usage.card.downloadConfig': 'Descargar archivo de autorización',
        'usage.card.downloadSuccess': 'Archivo de autorización descargado exitosamente',
        'usage.card.downloadFailed': 'Error al descargar archivo de autorización',
        'usage.card.freeTrial': 'Prueba gratuita',
        'usage.card.bonus': 'Bono',
        'usage.card.expires': 'Expira: {time}',
        'usage.doubleClickToRefresh': 'Doble clic para actualizar el uso de este proveedor',
        'usage.refreshingProvider': 'Actualizando uso de {name}...',
        'usage.group.expandAll': 'Expandir todas las tarjetas',
        'usage.group.collapseAll': 'Contraer todas las tarjetas',
        'usage.failedToLoad': 'Error al cargar',
        'usage.loadFailed': 'Error al obtener la lista de proveedores soportados',
        'usage.resetInfo': 'Se restablecerá en {time}',
        'usage.weeklyLimit': 'Límite semanal',
        'usage.time.days': '{days}días{hours}horas',
        'usage.time.hours': '{hours}horas{minutes}minutos',
        'usage.time.minutes': '{minutes}minutos',
        'usage.time.soon': 'Próximamente',
        
        // Logs
        'logs.title': 'Logs en Tiempo Real',
        'logs.clear': 'Limpiar logs',
        'logs.download': 'Descargar logs',
        'logs.autoScroll': 'Auto scroll',
        'logs.autoScroll.on': 'Auto scroll: Encendido',
        'logs.autoScroll.off': 'Auto scroll: Apagado',
        'logs.clear.confirm.title': 'Advertencia',
        'logs.clear.confirm.msg': '¡Esta acción limpiará los archivos de logs locales del día!\n\n• Los logs en tiempo real de la página serán limpiados\n• Los archivos de logs del día en el servidor también serán limpiados\n• Esta acción no se puede recuperar\n\n¿Está seguro de que desea continuar?',
        'logs.clear.success.title': 'Limpieza exitosa',
        'logs.clear.success.msg': 'Los logs en tiempo real del frontend y los archivos de logs del día en el servidor han sido limpiados',
        'logs.clear.failed': 'Error al limpiar logs',
        
        // Plugins
        'plugins.title': 'Gestión de Plugins',
        'plugins.description': 'El sistema de plugins le permite extender las funcionalidades del sistema, habilitar o deshabilitar plugins requiere reiniciar el servicio para aplicar cambios',
        'plugins.stats.total': 'Total de plugins',
        'plugins.stats.enabled': 'Habilitados',
        'plugins.stats.disabled': 'Deshabilitados',
        'plugins.refresh': 'Actualizar lista de plugins',
        'plugins.loading': 'Cargando lista de plugins...',
        'plugins.empty': 'No hay plugins instalados',
        'plugins.noDescription': 'Sin descripción',
        'plugins.status.enabled': 'Habilitado',
        'plugins.status.disabled': 'Deshabilitado',
        'plugins.badge.middleware.title': 'Incluye middleware',
        'plugins.badge.routes.title': 'Incluye rutas',
        'plugins.badge.hooks.title': 'Incluye hooks',
        'plugins.toggle.success': 'Plugin {name} {status}',
        'plugins.toggle.failed': 'Error al cambiar el estado del plugin',
        'plugins.load.failed': 'Error al cargar la lista de plugins',
        'plugins.restart.required': 'Cambios guardados',

        // Models
        'models.title': 'Lista de Modelos Disponibles',
        'models.note': 'Haga clic en el nombre del modelo para copiar al portapapeles',
        'models.empty': 'No hay modelos disponibles',
        'models.loadError': 'Error al cargar la lista de modelos',
        'models.copied': 'Copiado',
        'models.clickToCopy': 'Clic para copiar',

        // Guide
        'guide.title': 'Guía de Usuario',
        'guide.intro.title': 'Acerca del Proyecto',
        'guide.intro.desc': 'AIClient2API es un servicio de proxy de API que rompe las limitaciones del cliente, convirtiendo modelos gratuitos como Gemini, Antigravity, Qwen Code, Kiro, que solo estaban disponibles dentro del cliente, en interfaces estándar compatibles con OpenAI que cualquier aplicación puede llamar.',
        'guide.intro.feature1.title': 'Acceso Unificado',
        'guide.intro.feature1.desc': 'A través del protocolo compatible con OpenAI, una configuración puede acceder a múltiples modelos de IA',
        'guide.intro.feature2.title': 'Romper Límites',
        'guide.intro.feature2.desc': 'A través del mecanismo de autorización OAuth, efectivamente rompe los límites de velocidad y cuota de la API gratuita',
        'guide.intro.feature3.title': 'Conversión de Protocolos',
        'guide.intro.feature3.desc': 'Soporta conversión inteligente entre los tres protocolos: OpenAI, Claude y Gemini',
        'guide.intro.feature4.title': 'Gestión de Grupo de Cuentas',
        'guide.intro.feature4.desc': 'Soporta polling de múltiples cuentas, failover automático y degradación de configuración',
        'guide.providers.title': 'Proveedores de modelos soportados',
        'guide.providers.badge.oauth': 'Autorización OAuth',
        'guide.providers.badge.experimental': 'Experimental',
        'guide.providers.badge.free': 'Uso gratuito',
        'guide.providers.badge.official': 'API Oficial',
        'guide.providers.gemini.desc': 'Accede a modelos Gemini a través de autenticación OAuth de Google, soporta modelos como gemini-3.1-pro-preview',
        'guide.providers.antigravity.desc': 'Accede a Gemini 3 Pro, Claude Sonnet 4.5 y otros modelos a través de la interfaz interna de Google',
        'guide.providers.kiro.desc': 'Usa gratuitamente modelos como Claude Opus 4.5, Claude Sonnet 4.5 a través del cliente Kiro',
        'guide.providers.qwen.desc': 'Accede a modelos como Qwen3 Coder Plus a través de autenticación OAuth de Alibaba Cloud',
        'guide.providers.claude.desc': 'Usa la API oficial de Claude o proxies de terceros para acceder a la serie de modelos Claude',
        'guide.providers.openai.desc': 'Usa la API oficial de OpenAI o proxies de terceros para acceder a la serie de modelos GPT',
        'guide.providers.iflow.desc': 'Accede a modelos como Qwen, Kimi, DeepSeek, GLM a través de autenticación OAuth de iFlow',
        'guide.providers.grok.desc': 'Accede a Grok-3, Grok-4 y otros modelos a través de la interfaz reversa de Grok, soporta generación de imágenes y video',
        'guide.client.title': 'Guía de Configuración del Cliente',
        'guide.client.desc': 'A continuación se muestra cómo configurar clientes de IA comunes, configure el endpoint de API a la dirección de este servicio:',
        'guide.client.cherry.step1': 'Abra Configuración → Proveedores de modelo',
        'guide.client.cherry.step2': 'Agregar proveedor personalizado',
        'guide.client.cherry.step3': 'Configure la dirección API como: http://localhost:3000/{provider}',
        'guide.client.cherry.step4': 'Ingrese la clave API (REQUIRED_API_KEY del archivo de configuración)',
        'guide.client.cline.step1': 'Abra la configuración de VS Code',
        'guide.client.cline.step2': 'Buscar configuración de Cline o Continue',
        'guide.client.cline.step3': 'Configure la Base URL de API como: http://localhost:3000/{provider}/v1',
        'guide.client.cline.step4': 'Ingrese la clave API y el nombre del modelo',
        'guide.client.note': 'Sugerencia: Reemplace {provider} con la ruta real del proveedor, como gemini-cli-oauth, claude-kiro-oauth, etc. Puede ver las rutas completas en los ejemplos de enrutamiento del panel de control.',
        'guide.faq.title': 'Preguntas Frecuentes',
        'guide.faq.q1': 'P: ¿Qué hago si la solicitud devuelve error 404?',
        'guide.faq.a1': 'R: Verifique si la ruta del endpoint es correcta. Algunos clientes añaden automáticamente una ruta después de la Base URL, causando rutas duplicadas. Verifique la URL real de la solicitud en la consola y elimine las partes多余的 de la ruta.',
        'guide.faq.q2': 'P: ¿Qué hago si la solicitud devuelve error 429?',
        'guide.faq.a2': 'R: 429 significa que la frecuencia de solicitudes es demasiado alta. Se recomienda configurar múltiples cuentas en el grupo de proveedores y habilitar el mecanismo de polling; o configurar una cadena de Fallback para degradación entre tipos.',
        'guide.faq.q3': 'P: ¿Qué hago si la autorización OAuth falla?',
        'guide.faq.a3': 'R: Asegúrese de que el puerto de callback OAuth sea accesible (Gemini: 8085, Antigravity: 8086, Kiro: 19876-19880). Los usuarios de Docker deben asegurarse de mapear correctamente estos puertos.',
        'guide.faq.q4': 'P: ¿Cómo veo la lista de modelos disponibles?',
        'guide.faq.a4': 'R: Haga clic en la página "Modelos Disponibles" en la barra lateral para ver la lista de modelos soportados por todos los proveedores configurados. Haga clic en el nombre del modelo para copiar.',
        'guide.faq.q5': 'P: ¿Qué hago si la respuesta de streaming se interrumpe?',
        'guide.faq.a5': 'R: Verifique la estabilidad de la red, aumente el tiempo de espera de solicitudes del cliente. Si usa un proxy, asegúrese de que el proxy soporte conexiones largas.',
        'guide.faq.q6': 'P: ¿Qué hago si la solicitud devuelve el error "No available and healthy providers"?',
        'guide.faq.a6': 'R: Todas las cuentas del proveedor están actualmente no saludables o deshabilitadas. Vaya a la página de "Grupos de Proveedores" para verificar el estado de las cuentas y probar la función "Restablecer a saludable" o "Verificar no saludables".',

        // Tutorial
        'tutorial.title': 'Tutorial de Configuración',
        'tutorial.step1.title': 'Paso 1: Obtener credenciales OAuth',
        'tutorial.step1.desc': 'Vaya a la página de autorización OAuth para obtener las credenciales de su proveedor de IA. Siga las instrucciones en pantalla para completar la autorización.',
        'tutorial.step2.title': 'Paso 2: Configurar proveedor',
        'tutorial.step2.desc': 'Vaya a la página de configuración y configure los parámetros del proveedor. Asegúrese de que el archivo de credenciales esté correctamente configurado.',
        'tutorial.step3.title': 'Paso 3: Verificar disponibilidad',
        'tutorial.step3.desc': 'Vaya a la página de "Grupos de Proveedores" para verificar que los nodos estén en estado saludable. Si hay nodos no saludables, puede intentar actualizarlos.',
        'tutorial.step4.title': 'Paso 4: Usar la API',
        'tutorial.step4.desc': 'Ahora puede usar el endpoint de API. Consulte los ejemplos de enrutamiento en el panel de control para ver cómo llamar a diferentes proveedores.',
        ...
        'common.headers': 'Encabezados',
        'common.body': 'Cuerpo',
        'common.param': 'Parámetro',
        'common.params': 'Parámetros',
        'common.query': 'Consulta',
        'common.response': 'Respuesta',
        'common.request': 'Solicitud',
        ...
        'login.subtitle': 'Ingrese la contraseña de administración para continuar',
        'login.password': 'Contraseña',
        'login.passwordPlaceholder': 'Ingrese la contraseña',
        'login.remember': 'Recordarme',
        'login.forgot': '¿Olvidó su contraseña?',
        'login.error.required': 'Por favor ingrese la contraseña',
        'login.error.incorrect': 'Contraseña incorrecta, por favor intente de nuevo',
        'login.error.incorrectWithLock': 'Contraseña incorrecta. Cuenta bloqueada por {time} minutos.',
        'login.error.incorrectWithRemaining': 'Contraseña incorrecta. {count} intentos restantes.',
        'login.error.locked': 'Cuenta temporalmente bloqueada debido a demasiados intentos fallidos. Por favor intente de nuevo en {time} segundos.',
        'login.error.tooFrequent': 'Demasiadas solicitudes, por favor disminuya la velocidad.',
        'login.error.postOnly': 'Solo se admiten solicitudes POST',
        'login.error.invalidJson': 'Formato de solicitud inválido (JSON)',
        'login.error.failed': 'Error al iniciar sesión, por favor verifique su conexión de red',
